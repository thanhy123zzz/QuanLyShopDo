...
<section class="page-section" id="contact">
	<div class="container">
		...
		<h2
			class="page-section-heading text-center text-uppercase text-secondary mb-0">Nhập
			1 sản phẩm mới vào kho</h2>
		<!-- Icon Divider-->
	...
	<div class="row justify-content-center">
		<div class="col-lg-8 col-xl-7">
			<form:form id="contactForm" data-sb-form-api-token="API_TOKEN"
				modelAttribute="product" method="post" action="them-san-pham" enctype="multipart/form-data">
				<!-- Name input-->
				...
				<div class="form-floating mb-3">
					<div class="custom-file">
						<label class="custom-file-label" for="name">Hình ảnh</label> <input
							...
							placeholder="Enter your name..." name ="image" data-sb-validations="required"
				...
				<c:if test="${status==true}">
					<div id="submitSuccessMessage">
						<div class="text-center mb-3">
							<div class="fw-bolder">Thêm thành công!</div>
							Sản phẩm ' ${product.name} ' đã được thêm vào kho. <br />
						</div>
					</div>
				</c:if>
				<c:if test="${status==false}">
					<div id="submitSuccessMessage">
						<div class="text-center mb-3">
							<div class="fw-bolder">Thêm thất bai!</div>
							Sản phẩm ' ${product.name} ' đã tồn tại <br />
						</div>
					</div>
				</c:if>
